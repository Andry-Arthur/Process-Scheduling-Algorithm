...
public class PSJFScheduler extends Scheduler {

	public PSJFScheduler(File file) {
		super(file);
		name = "pSFJ";
	}
	...
	public void run() {
		...
		try {
			...
			PriorityQueue<ProcessInfo> ready = new PriorityQueue<>(new burstComparator());
			...
			while(!processes.isEmpty() || !ready.isEmpty() || onCpu != null) {
				...
				if(!ready.isEmpty()) {
					...
					if(onCpu == null) {
						...
						if(ready.peek().burstTime < onCpu.burstTime) {
